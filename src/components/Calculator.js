                ...
                <div className="calculator-keypad">
                    <div className="input-keys">
                        <div className="function-keys">
                            <CalculatorKey className="key-clear" onPress={() => this.clearAll()}>C</CalculatorKey>
                            <CalculatorKey className="key-sign" onPress={() => this.clearLastChar()}>DEL</CalculatorKey>
                        ...
                        <div className="digit-keys">
                            ...
                            <CalculatorKey className="key-dot" onPress={() => this.inputDot()}>&middot;</CalculatorKey>
